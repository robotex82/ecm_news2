...
feature 'Ecm::News::Item admin' do
  ...
  describe 'new' do
    ...
    scenario 'should be visitable' do
      expect(page.current_path).to eq("#{@admin_area_path}/#{@resource_path}/new")
    end # scenario
  ...
  describe 'edit' do
    ...
    scenario 'should be visitable' do
      expect(page.current_path).to eq("#{@admin_area_path}/#{@resource_path}/#{@resource.to_param}/edit")
    end # scenario
    ...
    describe 'when filling the form correctly' do
      ...
      scenario 'should not have created a record' do
        expect(@resource_class.count).to eq(@resource_count)
      end # scenario
  ...
  describe 'delete' do
    ...
    scenario 'should redirect to the resource index page' do
      expect(page.current_path).to eq("#{@admin_area_path}/#{@resource_path}")
    end # scenario
  end # describe 'delete'
